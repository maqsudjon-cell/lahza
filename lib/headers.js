 ...
 *   tadam.goatcounter.com — hisoblagich ma'lumot yuboradigan manzil
...
const CSP = [
  ...
  "font-src 'self'",
  "img-src 'self' data: blob: https://tadam.goatcounter.com",
  "connect-src 'self' https://tadam.goatcounter.com",
  "form-action 'self'",
  "base-uri 'self'",
  "object-src 'none'",
...
const BASE = {
  ...
  // saytga faqat `https://tadam.uz` ni yuboradi, `?i=...` ni emas.
 ...
 * tadam.uz ichida begona kod ishga tushishi demak. `sandbox` va
